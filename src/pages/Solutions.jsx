      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <button className="px-6 py-2 bg-primary text-white rounded-full hover:bg-dark transition">Learn More</button>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <button className="px-6 py-2 bg-primary text-white rounded-full hover:bg-dark transition">Get Started</button>
          </div>
        </div>
      </div>
    </div>
