    ...
    return (
        <div className="py-20">
            <div className="max-w-7xl mx-auto px-4">
                <div className="mb-12">
                    <h1 className="text-5xl font-serif font-bold text-gray-900 mb-4">Shop All Scents</h1>
                    <p className="text-xl text-gray-600">Discover our complete collection of premium fragrances</p>
                </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button 
                                        ...
                                        className="px-4 py-2 bg-black text-white rounded-full hover:bg-gray-800 transition font-medium"
                                    >
                                        Add to Cart
                                    </button>
                                </div>
