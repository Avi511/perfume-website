...
const About = () => {
  return (
    <div>
      ...
      <div className="py-12 sm:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16">
            ...
            <div className="text-center">
              <Heart size={40} className="mx-auto mb-4 text-[#EE6983]" />
            ...
            <div className="text-center">
              <Globe size={40} className="mx-auto mb-4 text-[#EE6983]" />
      ...
      {/* Team */}
      <div className="py-12 sm:py-20 bg-secondary">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition">
                <div className="w-24 h-24 bg-linear-to-br from-light to-accent rounded-full mx-auto mb-4"></div>
      ...
      <div className="py-12 sm:py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">25K+</p>
              <p className="text-gray-600">Happy Customers</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">150+</p>
              <p className="text-gray-600">Fragrances</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">75</p>
              <p className="text-gray-600">Countries</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">10 Yrs</p>
